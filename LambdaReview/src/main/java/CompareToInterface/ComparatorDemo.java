...
public class ComparatorDemo {
    public static void main(String[] args) {
       ...
       myInventory.sort(sortApple);
        ...
        myInventory.sort(comparing(Apple::getWeight)); // ascending order

        myInventory.sort(comparing((Apple::getWeight)).reversed()); // descending order
